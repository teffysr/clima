...
function hideNav(){
	...
	if(main.hasClass('hiddenNav')){
		var el = '<div class="showNav"><a href="#" rel="tooltip" title="Mostrar navegación" data-placement="right" class="button button-basic button-icon"><i class="icon-arrow-right"></i></a></div>'
		if($(".showNav").length == 0){
			$("#content").prepend(el);
